...
// WORD PAGE
export const NO_WORD_TEXT = (word) => `${word} not found!`;
export const NO_ENTRIES_TEXT = (word) => `No entries found for ${word}`;
export const ENTRIES_FOUND = (word) => `Entries for ${word}`;
export const QUERY_ERROR = (error) => `Error! ${error}`;

// USER PAGE
export const USER_NOT_FOUND = `User not found!`;
export const USER_NO_ENTRIES = (username) =>
  `No entries found for user: ${username}`;
export const USER_ENTRIES_FOUND = (username) => `Entries by ${username}`;

// TAG PAGE
export const TAG_NOT_DOUND = (tag) => `Tag: ${tag} not found!`;
export const TAG_NO_ENTRIES = (tag) => `No entries found for tag: ${tag}`;
export const TAG_ENTRIES_FOUND = (tag) => `Entries with tag: ${tag}`;
